...
- TechStrikeParalyzeConfig.cs: Example of ModConfig for custom mod settings;
- TechStrikeParalyzeGeoscape.cs: Example of ModGeoscape for modifying geoscape level;
- TechStrikeParalyzeMain.cs: Main mod class, recieves mod management and general events;
- TechStrikeParalyzeTactical.cs: Example of ModTactical for modifying tactical level;
